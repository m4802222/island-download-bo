...
docker exec "$container" sh -c \
    'python -m py_compile /app/simplebot.py /app/islandbot/*.py && python -c "import islandbot; print(islandbot.__version__)"'
